...
public class DriverBT 
{
	...
	public void test_JUnit() {
		System.out.println("This is the testcase for this project, using Tree 1.");
		BinaryTree<String> aTree = new BinaryTree<>();
		createTree1(aTree);

		System.out.println();

		System.out.println("Test the binaryTree method");
		//String postOrder = "DEBGFCA";
		aTree.postorderTraverse();
		//not sure how to get the output of postorderTraverse so I can show it's equal to postOrder

		System.out.println();

		System.out.println("Test the binaryNode method");
		aTree.postorderTraverse_callBinaryNodeMethod();
		//same issue here

		System.out.println();

		System.out.println("Test the getHeight in BinaryTree");
		int heightActual = 4;
		int heightMethod = aTree.getHeight();
		assertEquals(heightActual, heightMethod);
		
		System.out.println();

		System.out.println("Test the getHeight in BinaryNode");
		int heightNode = aTree.getHeight_callBinaryNodeMethod();
		assertEquals(heightActual, heightNode);

		System.out.println();

		System.out.println("Test the getNumberOfNodes method in BinaryTree");
		int nodesActual = 8;
		int nodesTree = aTree.getNumberOfNodes();
		assertEquals(nodesActual, nodesTree);

		System.out.println();

		System.out.println("Test the getNumberOfNodes method in BinaryNode");
		int nodesNode = aTree.getNumberOfNodes_callBinaryNodeMethod();
		assertEquals(nodesActual, nodesNode);
